...
public class jsoniqParser extends Parser {
	...
	public static class LibraryModuleContext extends ParserRuleContext {
		public TerminalNode Kmodule() { return getToken(jsoniqParser.Kmodule, 0); }
		...
		public TerminalNode Keq_symbol() { return getToken(jsoniqParser.Keq_symbol, 0); }
	...
	public final StatementsAndOptionalExprContext statementsAndOptionalExpr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -806648544724L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 11540474045136895L) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & 4201L) != 0)) {
				{
				setState(311);
				expr();
				}
	...
	public static class AssignStatementContext extends ParserRuleContext {
		...
		public TerminalNode Kassign() { return getToken(jsoniqParser.Kassign, 0); }
	...
	public final FlowrStatementContext flowrStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 27073274810728448L) != 0)) {
				{
				setState(365);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final CatchCaseStatementContext catchCaseStatement() throws RecognitionException {
		...
		try {
			...
			case T__6:
				{
				setState(412);
				((CatchCaseStatementContext)_localctx).s7 = match(T__6);
				((CatchCaseStatementContext)_localctx).jokers.add(((CatchCaseStatementContext)_localctx).s7);
				}
				break;
			case Kfor:
			case Klet:
	...
	public static class OrderingModeDeclContext extends ParserRuleContext {
		public TerminalNode Kdeclare() { return getToken(jsoniqParser.Kdeclare, 0); }
		public TerminalNode Kordering() { return getToken(jsoniqParser.Kordering, 0); }
		public TerminalNode Kordered() { return getToken(jsoniqParser.Kordered, 0); }
	...
	public final OrderingModeDeclContext orderingModeDecl() throws RecognitionException {
		...
		try {
			...
			setState(533);
			_la = _input.LA(1);
			if ( !(_la==Kunordered || _la==Kordered) ) {
	...
	public static class DecimalFormatDeclContext extends ParserRuleContext {
		...
		public List<TerminalNode> Keq_symbol() { return getTokens(jsoniqParser.Keq_symbol); }
		public TerminalNode Keq_symbol(int i) {
			return getToken(jsoniqParser.Keq_symbol, i);
		}
	...
	public static class VarDeclContext extends ParserRuleContext {
		...
		public TerminalNode Kexternal() { return getToken(jsoniqParser.Kexternal, 0); }
	...
	public final VarDeclContext varDecl() throws RecognitionException {
		...
		try {
			...
			case Kexternal:
				...
				{
				setState(599);
				((VarDeclContext)_localctx).external = match(Kexternal);
				setState(602);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==Kassign) {
	...
	public final ContextItemDeclContext contextItemDecl() throws RecognitionException {
		...
		try {
			...
			case Kexternal:
				...
				{
				setState(615);
				((ContextItemDeclContext)_localctx).external = match(Kexternal);
				setState(618);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==Kassign) {
	...
	public static class FunctionDeclContext extends ParserRuleContext {
		...
		public TerminalNode Kfunction() { return getToken(jsoniqParser.Kfunction, 0); }
		public QnameContext qname() {
			return getRuleContext(QnameContext.class,0);
		}
		public TerminalNode Kexternal() { return getToken(jsoniqParser.Kexternal, 0); }
	...
	public final GroupByVarContext groupByVar() throws RecognitionException {
		...
		try {
			...
			if (_la==Kas || _la==Kassign) {
				...
				setState(777);
				((GroupByVarContext)_localctx).decl = match(Kassign);
				setState(778);
	...
	public final CatchClauseContext catchClause() throws RecognitionException {
		...
		try {
			...
			case T__6:
				{
				setState(916);
				((CatchClauseContext)_localctx).s7 = match(T__6);
				((CatchClauseContext)_localctx).jokers.add(((CatchClauseContext)_localctx).s7);
				}
				break;
			case Kfor:
			case Klet:
	...
	public static class ComparisonExprContext extends ParserRuleContext {
		...
		public Token Kgt;
		public Token Kge;
		public Token Keq_symbol;
		public Token Kne_symbol;
		public Token Klt_symbol;
		public Token Kle_symbol;
		public Token Kgt_symbol;
		public Token Kge_symbol;
		...
		public TerminalNode Keq() { return getToken(jsoniqParser.Keq, 0); }
		public TerminalNode Kne() { return getToken(jsoniqParser.Kne, 0); }
		public TerminalNode Klt() { return getToken(jsoniqParser.Klt, 0); }
		public TerminalNode Kle() { return getToken(jsoniqParser.Kle, 0); }
		public TerminalNode Kgt() { return getToken(jsoniqParser.Kgt, 0); }
		public TerminalNode Kge() { return getToken(jsoniqParser.Kge, 0); }
		public TerminalNode Keq_symbol() { return getToken(jsoniqParser.Keq_symbol, 0); }
		public TerminalNode Kne_symbol() { return getToken(jsoniqParser.Kne_symbol, 0); }
		public TerminalNode Klt_symbol() { return getToken(jsoniqParser.Klt_symbol, 0); }
		public TerminalNode Kle_symbol() { return getToken(jsoniqParser.Kle_symbol, 0); }
		public TerminalNode Kgt_symbol() { return getToken(jsoniqParser.Kgt_symbol, 0); }
		public TerminalNode Kge_symbol() { return getToken(jsoniqParser.Kge_symbol, 0); }
	...
	public final ComparisonExprContext comparisonExpr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((((_la - 119)) & ~0x3f) == 0 && ((1L << (_la - 119)) & 4095L) != 0)) {
				{
				setState(956);
	...
	public final MultiplicativeExprContext multiplicativeExpr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 7516192896L) != 0)) {
				{
				{
				setState(982);
				((MultiplicativeExprContext)_localctx)._tset2148 = _input.LT(1);
				_la = _input.LA(1);
				if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 7516192896L) != 0)) ) {
	...
	public static class ArrowExprContext extends ParserRuleContext {
		...
		public List<TerminalNode> Kgt_symbol() { return getTokens(jsoniqParser.Kgt_symbol); }
		public TerminalNode Kgt_symbol(int i) {
			return getToken(jsoniqParser.Kgt_symbol, i);
		}
	...
	public static class ContextItemExprContext extends ParserRuleContext {
		public TerminalNode Kcontext_dollars() { return getToken(jsoniqParser.Kcontext_dollars, 0); }
	...
	public final ArgumentListContext argumentList() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -806648544724L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 11540474045136895L) != 0) || ((((_la - 131)) & ~0x3f) == 0 && ((1L << (_la - 131)) & 4217L) != 0)) {
				{
				{
				setState(1150);
		...
		try {
			...
			case NCName:
				...
				case 2:
					{
					setState(1267);
					((SequenceTypeContext)_localctx).s7 = match(T__6);
					((SequenceTypeContext)_localctx).star.add(((SequenceTypeContext)_localctx).s7);
					}
					break;
				case 3:
					{
					setState(1268);
					((SequenceTypeContext)_localctx).s28 = match(T__27);
					((SequenceTypeContext)_localctx).plus.add(((SequenceTypeContext)_localctx).s28);
					}
					break;
				}
				}
	...
	public final ObjectConstructorContext objectConstructor() throws RecognitionException {
		...
		try {
			...
			case T__37:
				...
				{
				setState(1285);
				((ObjectConstructorContext)_localctx).s38 = match(T__37);
				((ObjectConstructorContext)_localctx).merge_operator.add(((ObjectConstructorContext)_localctx).s38);
				setState(1286);
				expr();
				setState(1287);
				match(T__38);
	...
	public final TypedFunctionTestContext typedFunctionTest() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -1099511627744L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 9288674231451647L) != 0) || _la==NullLiteral || _la==NCName) {
				{
				setState(1307);
	...
	public final PairConstructorContext pairConstructor() throws RecognitionException {
		...
		try {
			...
			setState(1329);
			_la = _input.LA(1);
			if ( !(_la==T__11 || _la==ArgumentPlaceholder) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final KeyWordsContext keyWords() throws RecognitionException {
		...
		try {
			...
			setState(1342);
			_la = _input.LA(1);
			if ( !(((((_la - 40)) & ~0x3f) == 0 && ((1L << (_la - 40)) & -1L) != 0) || ((((_la - 104)) & ~0x3f) == 0 && ((1L << (_la - 104)) & 4294967551L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
